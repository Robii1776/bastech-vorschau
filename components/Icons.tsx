...
/* Linien-Icons nach Feather (ISC-Lizenz), WhatsApp nach Simple Icons (CC0) */

export function PhoneIcon({ size = 20, className, strokeWidth = 1.8 }: IconProps) {
  return (
...
export function MailIcon({ size = 20, className, strokeWidth = 1.8 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden>
