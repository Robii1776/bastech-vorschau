...
export const metadata: Metadata = {
  ...
  description:
    "Service, Revisionen, Reparaturen, Ersatzteile und Occasionsmaschinen für die Schweizer Industrie: Produktions-, Verpackungs-, Förder- und Umreifungsanlagen. Bastech Betriebe AG, Mehlsecken LU.",
  keywords: [
    "Industrieservice",
    "Maschinenreparatur",
    "Verpackungstechnik",
